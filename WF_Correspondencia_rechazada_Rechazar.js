...
(async () => {
    ...
    await recorder.start('./Videos/WF_Correspondencia_Rechazada_Rechazar.mp4');
    await animate(page);
    ...
    await page.screenshot({ path: './Capturas/pagina_Login_Correspondencia_Rechazada_Rechazar.png' })
    await page.click('button.btn.btn-primary.loginButton')
    await new Promise(r => setTimeout(r, 20000));
    await page.screenshot({ path: './Capturas/bandeja_Correspodencia_Rechazada_Rechazar.png' })
    ...
    await ingresoDocuments.click('#tblAdHoc2298')
    ...
    await ingresoHostFrame.type('#motivoderechazo7_input', 'NO TENGA LA INFORMACIÓN COMPLETA')
    ...
    console.log('Se da click en el botón Enviar para finalizar el flujo')
    await new Promise(r => setTimeout(r, 6000));
    //#endregion
